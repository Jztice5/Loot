...
当前项目处于 Phase 0 架构基础阶段，已建立 Python 项目骨架和第一批核心 contracts。现有 `main.py` 仍是 PyCharm 示例脚本，下一步会围绕 Signal State Machine、FakeProvider 和 Golden Case 搭第一条可运行闭环。
...
3. 用 Crypto 自选跑通 Candidate 到 Signal 到 Alert 的最小闭环。
